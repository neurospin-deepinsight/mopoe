...
# DATA DEPENDENT
parser.add_argument('--class_dim', type=int, default=20,
...
parser.add_argument(
    '--dir_experiment',
    type=str,
    default='/tmp/multilevel_multimodal_vae_swapping',
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help=("flag to indicate if figures should be saved to disk (in addition "
          "to tensorboard logs)"))
parser.add_argument(
    '--eval_freq',
    type=int,
    default=10,
    help=("frequency of evaluation of latent representation of generative "
