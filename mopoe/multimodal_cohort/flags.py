...
parser.add_argument('--img_size_m1', type=int, default=28,
...
parser.add_argument('--img_size_m2', type=int, default=32,
                    help="img dimension (width/height)")
parser.add_argument(
    '--num_channels_m2',
    type=int,
...
parser.add_argument(
    ...
    default=[
        ...
        444,
        24],
    help="input dimension for each modality")
parser.add_argument(
    '--initial_out_logvar',
    type=float,
    default=0,
    help="initial output logvar")
parser.add_argument(
    '--learn_output_scale',
    action='store_true',
    default=False,
    help="allows for different scales per feature")
parser.add_argument(
    '--allow_missing_blocks',
    action='store_true',
    default=False,
    help="allows for missing modalities")
